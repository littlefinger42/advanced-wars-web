...
export function getPath(map, unit, units, destX, destY, weather = 'clear') {
    const def = getUnitDefinition(unit.type);
    if (!def)
        return [];
...
export function getAttackableTilesFromPosition(map, unit, fromX, fromY, units) {
